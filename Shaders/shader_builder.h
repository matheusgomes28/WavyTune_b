...
public:
	...
	ShaderBuilder& set_vertex_shader(const ByteArray& data);
	ShaderBuilder& set_vertex_shader(ByteArray&& data);
	ShaderBuilder& set_vertex_shader(std::unique_ptr<VertexShader> vs);

	ShaderBuilder& set_fragment_shader(const ByteArray& data);
	ShaderBuilder& set_fragment_shader(ByteArray&& data);
	ShaderBuilder& set_fragment_shader(std::unique_ptr<FragmentShader> fs);

	ShaderBuilder& set_geometry_shader(const ByteArray& data);
	ShaderBuilder& set_geometry_shader(ByteArray&& data);
