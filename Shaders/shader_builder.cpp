...
ShaderBuilder& ShaderBuilder::set_fragment_shader(const ByteArray& data)
{
	if (!shader_program_)
	{
...
ShaderBuilder& ShaderBuilder::set_fragment_shader(ByteArray&& data)
{
	if (!shader_program_)
	{
		// TODO : shader_program_ is no longer 
...
ShaderBuilder& ShaderBuilder::set_geometry_shader(const ByteArray& data)
{
	if (!shader_program_)
	{
		// TODO : shader_program_ is no longer
...
ShaderBuilder& ShaderBuilder::set_geometry_shader(ByteArray&& data)
{
	if (!shader_program_)
	{
		// TODO : shader_program_ is no longer
...
ShaderBuilder& ShaderBuilder::set_vertex_shader(const ByteArray& data)
{
	if (!shader_program_)
	{
		// TODO : shader_program_ is no longer
...
ShaderBuilder& ShaderBuilder::set_vertex_shader(ByteArray&& data)
{
	if (!shader_program_)
	{
		// TODO : shader_program_ is no longer
